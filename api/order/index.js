...
module.exports = app =>  {
    app.get(endpoint_name + "/getMyOrder",auth.isAuthenticated(), handleReq(controller.getMyOrder))
    app.post(endpoint_name + "/createMyOrder",auth.isAuthenticated(), handleReq(controller.createMyOrder))
